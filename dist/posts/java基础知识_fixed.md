...
参见：<https://mp.weixin.qq.com/s?__biz=MzI5MTQ5NDY1MA==&mid=2247492178&idx=1&sn=99f839c4b11a8ab9e63b2941e98cc57c&chksm=ec0d6dc7db7ae4d1c0ddde31e900f668221fad36ea31a7db6447bd6d5f7015e9481bd1bcd24c&scene=27>
...
![alt text](79b95be118bd41f88758e84def7d23e0.png)

**```static```修饰的成员变量的内存原理**
![alt text](3ada81ca5fb149b186a131fafbdf31dd.png)
...
参见：<https://blog.csdn.net/Javascript_tsj/article/details/127163683>
...
参见：
1：<https://blog.csdn.net/TYRA9/article/details/129174384>
2：<https://blog.csdn.net/m0_52196529/article/details/127192171>
...
输出结果：
![alt text](aead386ceec643bbac36018a445f4da0.png)
...
参见：<https://blog.csdn.net/weixin_45395059/article/details/126006369>
...
参见：<https://blog.csdn.net/shalimu/article/details/105198961>
...
参见：<https://blog.csdn.net/m0_70322372/article/details/127829707>
...
它能够修饰的程序元素包括类型、属性、方法、参数、构造器、局部变量，只能存活在源码时，取值为String[]。它的作用是告诉编译器忽略指定的警告信息，它可以取的值可参照：https://www.pdai.tech/md/java/basic/java-basic-x-annotation.html
...
**Java注解大全**
<https://blog.csdn.net/qq_45807943/article/details/116980851>
...
![alt text](dcec8416e6c84734945895ce7562a672.png)
...
**三同**：方法签名（方法名称、参数列表和返回类型）必须与父类中被重写的方法相同。如果方法名称不相同，将被编译器视为子类新扩展出的方法。同理，如果方法的参数不同，则被编译器视为子类新增加了一个“重载”关系的方法。如果返回值不同，则被编译器视为违反重写规则。
   ...
   ![alt text](v2-4e7fbcbce3ddc762bfca92a091b483bd_r.png)
...
![alt text](v2-1a054ad80790178dbfeae1bd5f4080cf_r.png)
...
参见：<https://blog.csdn.net/qq_61635026/article/details/131245120>
...
![alt text](91d44def1a5847b29c1181c126b982e0.gif)
...
![alt text](62cee712391b4a078400650052278072.png)

#### 21.2.3 特点

2.3.1. 若父类中定义了一个抽象方法，要求其所有非抽象子类都必须重写该抽象方法。否则IDEA会报错。

![alt text](7e508b4031e44452b33fe4035b96aa6c.png)
...
![alt text](43f6bf7a8dc04a4aa7197061f5d871d4.png)

&ensp;&ensp;&ensp;&ensp;当然，如果抽象类的子类没有用abstract关键字修饰，那么我们可以创建其子类对象，如下图所示 :

![alt text](8a69ddd6721d41a9b24c4a32ef9bcbeb.png)
...
![alt text](b506567b762d45d5bf2e46c5f4a8b1cf.png)
...
![alt text](fa2bcc0239354f72a9f568c1479b066b.png)
...
![alt text](421c52f4775845aaa4b77483e2fcdcc9.png)

![alt text](003f4727c94343e0b1edcc579a3b6115.png)
...
参见：
<https://blog.csdn.net/iiiiiihuang/article/details/130671801>
...
<https://blog.csdn.net/qq_61635026/article/details/131104866>
...
https://blog.csdn.net/2301_77162163/article/details/131231597
...
参见：
https://blog.csdn.net/lu202032/article/details/117047712
https://blog.csdn.net/m0_71777195/article/details/131498454
...
![alt text](java-string-1-2020-12-01.png)
...
![alt text](../../../../../AppData/Local/Temp/2021-03-01-java-stringbuffer.svg)
...
- Stream流的思想
  ...
  ![01_Stream流思想](D:\Desktop\mdnote\JAVA\Java_basic\java_basic.assets\01_Stream流思想.png)
...
![alt text](e9b727bd17d3465f98adb813e491daca.png)
...
![alt text](fc25464356be48d1aaeaa974092350e0.png)
...
![alt text](699722b0708a4f2c914f8a3ae74de6f2.png)
...
![alt text](fc6a5d2297ce4d03a275a29b2a159355.png)
...
![alt text](80d34aea6be24d158cbdc69c295a7729.png)
